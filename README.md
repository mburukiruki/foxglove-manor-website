...
<nav id="navbar" class="fixed top-0 left-0 right-0 w-full z-50 glass-nav py-4 border-b border-slate-100 shadow-sm">
...
<section id="home" class="pt-24 pb-20 md:pt-32 md:pb-32 hero-gradient overflow-hidden">
